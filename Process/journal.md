...
# Week 11 - April 9, 2026

As the project approaches its final stage, this week focused on consolidating the various systems I’ve been developing into a more cohesive and intentional experience. Up until now, much of the work existed as interconnected but somewhat isolated components—AI dialogue generation, text-to-speech playback, environmental design, and interaction systems. This week marked the transition from experimentation toward unification, where the goal was to ensure that all of these elements work together seamlessly as part of a singular gameplay loop.

A major area of focus was refining the interaction pipeline between the player and the AI-driven NPC. Rather than simply triggering isolated voice lines, I began shaping the system into a more complete conversational structure, where input, response generation, and audio playback feel like parts of a continuous exchange. This aligns more closely with the idea of a “therapy session” mechanic, where the player engages with the soldier not just as a reactive entity, but as a character with memory, instability, and evolving responses. The intention here is to move beyond novelty and toward something that feels psychologically engaging and narratively grounded.

Additionally, most of said time was spent working upon the "aggression" system, where I made sure the AI and you could have a proper conversation before a fight would fully break out and the soldier would try to kill you. Thanks to Biancas idea, which actually involved tying the system to a "sanity" meter, which would directly change the AIs top_p score and make its answers more manic the higher the score, it actually ended up working after a couple days of troubleshooting.

In parallel, I continued optimizing the performance of the system, particularly addressing the delays caused by AI response generation and text-to-speech processing. This included experimenting with techniques such as preloading models, reducing unnecessary processing steps, and restructuring how dialogue is generated and delivered. While latency remains a challenge, the system is now significantly more responsive than before, making real-time interaction feel more viable within the constraints of the project.

This week also involved reflecting on how the environment supports the core experience. The mansion is no longer just a constructed space, but a stage for interaction—its layout, lighting, and isolation all contribute to the tone of the encounter. The therapy room in particular now functions as a focal point, both mechanically and narratively, reinforcing the idea of confrontation, introspection, and unease. The surrounding environment serves to guide the player into this space, framing the interaction as something deliberate rather than incidental.

In the context of the course structure, this week represents the shift from iterative prototyping into final synthesis. Each previous prototype contributed a piece—AI behavior, environmental storytelling, interaction systems—and this phase is about layering them into a refined, playable experience. The project is evolving into a vertical slice that demonstrates not only technical integration, but also a clear conceptual direction: an AI-driven interaction centered on trauma, perception, and fragmented communication.

Looking ahead, for some more expansive parts of our game, I definitely want more soldiers scattered around for you to talk to. It, at the moment, does feel slightly isolating with a mansion housing a singular soldier within.

Plus, I also want more guidances of what to do, from how the controls operate to what is actually possible to do in the game. Systems are not as explained as I would've wanted them to be, and I wanted to possibly change that by adding in more prompts and guides, within the mad-god style of belittlement and an outer-wordly experience.